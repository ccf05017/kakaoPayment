...
- [X] Parser
    ...
    - [ ] 카드사에 보낼 데이터 타입으로 변환할 수 있어야 한다.
        - String 파싱 자체가 더 큰 책임이기 때문에 Payment 객체에서 따로 분리
...
- [ ] Payment
    ...
    - [X] 세금 자동 계산으로 결제 객체를 만들 수 있다.
    - [X] 세금 수동 계산으로 결제 객체를 만들 수 있다.
    - [X] 세금 자동 계산으로 결제전액취소 객체를 만들 수 있다.
    - [X] 세금 수동 계산으로 결제전액취소 객체를 만들 수 있다.
    - [X] PaymentFactory 구현
